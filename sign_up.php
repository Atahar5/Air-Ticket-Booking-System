...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-primary nav-all">
      ...
      <a class="navbar-brand" href="home.php"> 𝐀𝐞𝐫𝐨 𝐁𝐚𝐧𝐠𝐥𝐚𝐝𝐞𝐬𝐡 <span><img style = "width: 45px; height: 37px;" src="images/plane_nav.png" alt=""></span></a>
        <button
        ...
        <form class="sign-up-main" action="create.php" method = "post" id="login-area">
            ...
            <div class="two-part right-part common">
                <div class="right-first right-back">
                    ...
                    <h5>Date of Birth</h5>
                    <input type="date" required placeholder="Birth Date" name = "bdate">
                    <div>
                ...
                <div class="right-last right-back">
                    ...
                    <h5>Phone Number</h5>
                    <input type="tel" required placeholder="Phone Number" name = "num">
                    <h5>Gender</h5>
