...
if(isset($_POST['from']) && isset($_POST['to']) && isset($_POST['buy']) && isset($_POST['adult']) && isset($_POST['child']) && isset($_POST['payment']) && $_POST['num']){
    ...
    if ($adult == '0' && $child == '0') {
      ...
      if (mysqli_num_rows($result_check) != 0) {
        ...
        <html lang="en">
          ...
          <body>
            ...
            <nav class="navbar navbar-expand-lg bg-primary nav-all">
              ...
              <a class="navbar-brand" href="home.php">Aero Bangladesh<span><img style = "width: 45px; height: 37px;" src="images/plane_nav.png" alt=""></span></a>
                <button
        ...
        $sql_available = "UPDATE flight set available = $flight_available where f_id = '$flight_id'";     #Ticket available count
